...
public class user_bluebooks extends AppCompatActivity {
    private DatabaseReference ProductRef;
    private RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    private String Category="Blue Books";
    private String type = "";
                            ...
                            protected void onBindViewHolder(@NonNull  ProductViewHolder holder, int i, @NonNull  Stationary_product stationary_product) {
                                ...
                                holder.itemView.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        {
                                            Intent intent = new Intent(user_bluebooks.this,user_product_detail_activity.class);
